  ...
  <el-row v-loading="loading">
    <el-col :span="24">
      <el-row class="search-row">
        ...
        <el-col :span="18">
          ...
          <div class="select-div-tt">
            ...
            >
              <el-option
                v-for="(value,key,index) in userList"
                :key="index"
                :label="value"
                :value="key"
              ></el-option>
      ...
      <div class="new_pag" style="margin-bottom: 60px;">
        <paging
          :totalNumber="pageObj.total"
          @currentPage="getcurrentpage"
          :pageSize="pageObj.pageSize"
          :changePage1="changePage"
        ></paging>
      </div>
      ...
      <div class="shadow2" v-show="second">
        ...
        <p>
          <span>时间：{{findList.createTime}}</span>
          来源：{{findList.source}}
        </p>
...
export default {
  ...
  methods: {
    ...
    editItem(item) {
      this.$router.push({
        path: this.dealRoute('articleAdd'),
        query: { id: item.id },
      })
    },
    switchItem(item) {
